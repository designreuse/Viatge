...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
		...
		<ul id="breadcrumb">
			...
			<li><i class="fa fa-lg fa-angle-right"></i></li>
			<li><a href="#" title="Novo Destino">Novo Destino</a></li>
		</ul>
		<!-- FIM BREADCRUMB -->
		...
		<div class="col-sm-12">
			<div class="nest" id="stepyClose">
				...
				<div class="title-alt">
					<h6>Cadastro do Novo Destino de Viagem</h6>
				</div>
				...
				<div class="body-nest" id="stepy">
					...
					<div class="demo">
						...
						<f:form id="transition-duration-demo" method="post" action="addDestination" modelAttribute="destination" enctype="multipart/form-data">
							...
							<fieldset title="Filtros">
                                ...
                                <ul class="list-checkbox skin skin-flat">
                                    ...
                                    <li>
                                        ...
                                        <f:checkbox id="tripProfiles.party1" path="tripProfiles.party"/>
                                    </li>
                                	...
                                	<div class="col-sm-6">
										...
										<script type="text/javascript">
                                            ...
                                            function changeiFrame() {											
                                                ...
                                                var iframe = document.getElementById("yt_frame");
                                                var result = input.split("=");
                                                
                                                
                                                if(result[0] == "https://www.youtube.com/watch?v" || result[0] == "www.youtube.com/watch?v" || result[0]== "http://www.youtube.com/watch?v"){
                                        ...
                                        <div class="well-media">
                                            <div class="vendor">
                                                <iframe
                                                    ...
                                                    width="400" height="225" frameborder="0" id="yt_frame"></iframe>
                                            </div>
                                            <div class="video-text">
                                                <h2>Link do Youtube</h2>
                                                <div class="tag-nest">
                                                    <f:input type="text" path="video.code" id="yt_input" placeholder="Ex:. https://www.youtube.com/watch?v=QEfPzNS3Shg" onblur="changeiFrame()" cssClass="form-control"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="well-media">
                                            <div id="street-view-div" class="vendor">                                                                                              
                                                 <iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?layer=c&amp;panoid=_3BG0a4MYf8AAAQXIE1gSA&amp;ie=UTF8&amp;source=embed&amp;output=svembed&amp;ll=-3.07891%2C-60.038074&amp;cbp=13%2C83.7416%2C%2C0%2C0"></iframe>
                                            </div>
    
                                            <div class="video-text">
                                                <h2>Link do StreetView</h2>
                                                <div class="tag-nest">
                                                	<f:input type="text" path="streetView.embedCode" placeholder="Cod. do Google Street View ou Photosphere..." id="street_in" cssClass="form-control"/>
                                            	</div>
                                            </div>
                                            <div class="audio-category-bg"><button id="submit-all" type="submit" class="stepy-finish pull-right btn btn-info">Pronto!</button>
                                                <h3>Tour Virtual</h3>
							...
							<fieldset title="Descrição">
                                ...
                                <ul class="list-checkbox skin skin-flat">
                                    <li>
                                    	<input type="checkbox" id="ckAppearInWebsite"  name="dtAppearWebsite"/>
                                        <label for="ckAppearInWebsite">Aparecer no Website</label>
                                    </li>
                                    
                                    <li>                                
                                    	<input type="checkbox" id="ckHighlightWebsite" name="dtHighlightWebsite"/>
                                        <label for="ckHighlightWebsite">Destacar no Website</label>
                                    </li>
                                </ul>
...
$(function() {
    $("div#myDropZone").dropzone({
        ...
        removedfile: function(file) {
            ...
            $.ajax({
                type: 'POST',
                url: '/viatge/file/delete?${_csrf.parameterName}=${_csrf.token}',
                data: "img="+name+"&"+"id="+param[1],
                dataType: 'html'
            });
        var _ref;
